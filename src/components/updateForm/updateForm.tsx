...
const UpdateForm: React.FC = (): JSX.Element => {
  ...
  const [all, setAll] = useState({
    phoneNumber: usr.phoneNumber ? usr.phoneNumber : "",
    avatar: usr.avatar,
    email: usr.email,
  ...
  return (
    <div className="updateForm">
      <div className="form-name">Update Account</div>
      <div style={{color:"red"}}>*After changes please login again </div>
      <div className="formU">
        <div className="line">
          <div>
            Telephone:
      ...
      <div>
        <button onClick={openDial} className="confirm-c">
          Submit Changes!
        </button>
      </div>
      <Dialog
